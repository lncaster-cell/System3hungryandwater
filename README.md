...
- `nwscript/city_law_system.nss` — система пакетов городских законов: владелец города назначает закон-пакет, а его параметры управляют поведением стражи и городскими модификаторами.
...
- В sync-контракт включены городские владельцы, назначенные law-пакеты и сами параметры пакетов законов для межрепозиторного переноса логики поведения стражи.
