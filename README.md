...
- `nwscript/trade_system.nss` — integer-only торговля: стандартный магазин, отдельный режим оптовой торговли ресурсами (тонны, лоты, ledger без инвентарных ограничений), модуль нелегальных товаров в формате простого списка (тип товара + наценка, например наркотики) и подготовка данных для GUI и вкладок.
